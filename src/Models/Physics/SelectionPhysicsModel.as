package Models.Physics
{
	...
	public class SelectionPhysicsModel extends ObjectPhysicsModel implements IPhysicsModel
	{
		...
		public function SelectionPhysicsModel(stage:Stage)
		{
			super(stage);
		...
		private function updatePlayerInput(deltaT:Number):void
		{
			...
			{
				dispatchEvent(new EFireCannon(EFireCannon.FIRE_ONE, 'selection'));
			}
			if(inputModel.getFireWeaponTwo()==true)
			{
				dispatchEvent(new EFireCannon(EFireCannon.FIRE_TWO, 'selection'));
			}
		}
